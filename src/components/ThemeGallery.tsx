...
export default function ThemeGallery({ screenshots, themeName, buttonOnly, buttonText }: ThemeGalleryProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      {buttonOnly ? (
        <button
          onClick={openViewAll}
          className="inline-flex flex-1 sm:flex-none items-center justify-center rounded-xl bg-gray-100 px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 transition-all duration-200 ease-out hover:bg-gray-50 active:scale-[0.97] dark:bg-gray-800 dark:text-gray-100 dark:ring-gray-700 dark:hover:bg-gray-700"
        >
